...
@Designate(ocd = ConfigMeter.class, factory = true)
@Component(//
		name = "Ziot.Generic.Meter", //
		immediate = true, //
		configurationPolicy = ConfigurationPolicy.REQUIRE //
)
public class ZiotGenericMeterImpl extends AbstractOpenemsModbusComponent
		implements ZiotGenericMeter, ElectricityMeter, ModbusComponent, OpenemsComponent, ModbusSlave {
	...
	public ZiotGenericMeterImpl() {
		super(//
				...
				ZiotGenericMeter.ChannelId.values() //
		);
	}
