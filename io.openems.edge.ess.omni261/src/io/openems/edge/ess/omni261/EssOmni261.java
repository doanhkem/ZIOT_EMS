...
public interface EssOmni261 extends ManagedSymmetricEss, SymmetricEss, ModbusComponent, OpenemsComponent, ModbusSlave {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		BESS_CHARGE_ENERGY_TODAY(Doc.of(LONG).unit(KILOWATT_HOURS)), //
		BESS_DISCHARGE_ENERGY_TODAY(Doc.of(LONG).unit(KILOWATT_HOURS)), //
