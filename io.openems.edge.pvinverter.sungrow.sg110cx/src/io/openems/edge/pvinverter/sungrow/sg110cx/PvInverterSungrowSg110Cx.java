...
public interface PvInverterSungrowSg110Cx extends ManagedSymmetricPvInverter, ElectricityMeter, ModbusComponent,
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		TMP_CAB(Doc.of(OpenemsType.INTEGER).unit(Unit.DEGREE_CELSIUS)), //
